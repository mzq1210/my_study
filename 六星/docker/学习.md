...
#### 8.哨兵+主从方案（适用于一主多从，但解决不了内存不够的问题）
...
# 2.执行
./redis-trib.rb create --replicas 1  118.24.109.254:6390 118.24.109.254:6391 118.24.109.254:6392 118.24.109.254:6393 118.24.109.254:6394  118.24.109.254:6395
#解释：
...
#扩容 实现节点添加  第一个ip是要加入的节点  第二个ip是集群中已存在的节点
